...
public class ConnectionManager {
     ...
     */
    private static final String STR_CONNECTION = "jdbc:sqlserver://localhost:1433;database=ClinicaVeterinaria;encrypt=true;trustServerCertificate=true;user=Fabi2025;password=0123";
